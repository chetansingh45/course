...
<div class="row">
	<div class="col-12">
		<div class="row align-items-center">
            <div class="col-md-6">
                <a href="{{ route('category.create') }}" class="btn btn-primary me-3 btn-sm"><i class="fas fa-plus me-2"></i>Add New Category</a>
            </div>
            <div class="col-md-6">
                        ...
                        <div class="card">
                            <div class="jobs2 text-center card-body">
                                <div class="text-center">
                                    ...
                                    <h4 class="fs-20 mb-0">{{ $category->name }}</h4>
                                    <span class="text-primary mb-3 d-block">{{ count($category->courses) }} Courses</span>
                                </div>
                                <div class="mb-3">
                                    <span class="badge badge-success badge-lg light abs-status">Active</span>
                                    <span class="d-block mb-1"><i class="text-primary font-normal">Posted Date:</i> {{ $category->created_at }}</span>
                                    {{-- <span class="d-block mb-1"><i class="text-primary font-normal">Last Date:</i> 20-01-2021</span> --}} 
                                </div>
                                <div class="action-buttons d-flex justify-content-center">
                                    <a href="job-view.php" class="btn btn-success light mr-2">
                                    ...
                                    <a href="{{ route('category.delete',$category->id) }}" class="btn btn-danger light">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <rect x="0" y="0" width="24" height="24"></rect>
