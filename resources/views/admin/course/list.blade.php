                            ...
                            <div class="jobs2 text-center card-body">
                                <div class="text-center">
                                    <span class="job_list_icon">
                                       <img src="{{ asset('images/courses').'/'.$course->image }}" height="100" width="150">
                                    </span>
                                    <h4 class="fs-20 mb-0">{{ $course->name }}</h4>
                                    <h6 class="">&#8377; {{ $course->price }}</h6>
                                    <h6 class="">{{ $course->duration }} Days</h6>
                                    <h6 class="">({{ $course->category->name }})</h6>
                                    <span class="text-primary mb-3 d-block">5 Students</span>
                                    <span class="text-primary mb-3 d-block">{{ count($course->videos) }} Videos</span>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="action-buttons d-flex justify-content-center">
                                    <a href="{{ route('course.view',$course->id) }}" class="btn btn-success light mr-2">
                                    ...
                                    <a href="{{ route('course.edit',$course->id) }}" class="btn btn-secondary light mr-2">
                                    ...
                                    <a href="{{ route('course.delete',$course->id) }}" class="btn btn-danger light">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <rect x="0" y="0" width="24" height="24"></rect>
